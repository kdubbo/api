...
var (
	...
	OrgApacheDubboInherentStatus = Instance{
		Name: "inherent.dubbo.apache.org/status",
		Description: "Generated by Inherent adapter injection that indicates " +
